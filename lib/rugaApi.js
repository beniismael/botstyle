...
const link2 = 'https://alfians-api.herokuapp.com'
...
const ytmp3 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://alfians-api.herokuapp.com/api/yta?url=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
...
const ytmp4 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://alfians-api.herokuapp.com/api/ytv?url=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
